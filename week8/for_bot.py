...
# Один из сценаривает скрипта: 1. Написать функцию распознания интенции, 
# 2. Функция для того, чтобы здороваться. 3. Функция, чтобы прощаться. 4. Функция для ошибок. 
